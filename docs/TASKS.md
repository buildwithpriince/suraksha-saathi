...
- [ ] T-10 [A] Scenario model + JSON loader + validation in `mobile/src/core/scenarios` (docs/02 contract) — Done when: loads both scenario files, rejects 5 malformed cases in tests (deps: T-04)
